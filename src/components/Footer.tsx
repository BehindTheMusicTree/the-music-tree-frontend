            ...
            <section aria-labelledby="footer-product-heading">
              ...
              <ul className="space-y-1.5">
                {productLinks.map(({ href, labelKey }) => (
                  <li key={href}>
                    <Link href={withLocalePath(href)} className={linkClassName}>
                      {messages.footer[labelKey]}
                    </Link>
                  </li>
                ))}
              </ul>
