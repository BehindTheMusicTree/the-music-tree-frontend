...
const WEBSITE_CARBON_HOME = "https://www.websitecarbon.com/";

export function WebsiteCarbonBadge() {
  const pathname = usePathname();
  const websiteCarbonLinkHref =
    websiteCarbonWebsiteResultsUrl(process.env.NEXT_PUBLIC_ORG_URL) ??
    WEBSITE_CARBON_HOME;
