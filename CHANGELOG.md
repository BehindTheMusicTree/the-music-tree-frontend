...
- **Header**: larger nav links (**`text-base`**), **Contribute** CTA (**`text-sm`**, padding), lockup image height **48px**, and nav vertical padding (**`py-5`**). Below **`sm`**, the header shows the **mark** only (**`the-music-tree-mark.svg`**); from **`sm`** up, the full **TheMusicTree** lockup (**wordmark**) is shown.
